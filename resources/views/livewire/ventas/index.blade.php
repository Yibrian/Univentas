                        ...
                        <div class="flex-1">
                            ...
                            @if ($venta->cupon)
                                <div class="mt-2">
                                    ...
                                    <p class="text-gray-600 text-sm">Código: <strong>{{ $venta->cupon->codigo }}</strong></p>
                                    <p class="text-gray-600 text-sm">Descuento: 
                                        {{ $venta->cupon->tipo === 'porcentaje' ? $venta->cupon->descuento . '%' : '$' . number_format($venta->cupon->descuento, 0) }}
                                    </p>
                                </div>
                            @endif
                        </div>
